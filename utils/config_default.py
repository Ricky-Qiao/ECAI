...
def get_cfg_default():
    ...
    #Dorset
    _C.MODEL.Dorset = CN()
    _C.MODEL.Dorset.TUNING = False
    _C.MODEL.Dorset.ALPHA = 3.0
    _C.MODEL.Dorset.BETA = 1.0
    _C.MODEL.Dorset.GAMMA = 0.1
    _C.MODEL.Dorset.LAMBDA = 0.7
    _C.MODEL.Dorset.SEARCH_SCALE = [15, 3, 0.5]
    _C.MODEL.Dorset.SEARCH_STEP = [30, 15, 5]
    _C.MODEL.Dorset.NUM_FEATURES = 256
    _C.MODEL.Dorset.BACKBONE = "Vit-B/32"
    _C.MODEL.Dorset.K = 10
