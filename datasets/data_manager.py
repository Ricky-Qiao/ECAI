...
class DataManager:
    def __init__(self, cfg):
        ...
        if cfg.MODEL.NAME in ['Dorset']:
            transform_train = build_transform(cfg, type="test")
        else:
            transform_train = build_transform(cfg, type="train")
        transform_test = build_transform(cfg, type="test")
        batch_size_test = cfg.DATALOADER.TEST.BATCH_SIZE
